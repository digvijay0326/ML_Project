...
class DataTransformation:
    def __init__(self):
        self.data_tranformation_cofig=DataTransformationConfig()
    ...
    def initiate_data_transformation(self,train_path,test_path):
        ...
        try:
            ...
            save_object(
                file_path=self.data_tranformation_cofig.preprocessor_obj_file_path,
                obj=preprocessing_object
            )
            return(
                train_arr,
                test_arr,
                self.data_tranformation_cofig.preprocessor_obj_file_path,
            )
        except Exception as e:
            raise CustomException(e,sys)